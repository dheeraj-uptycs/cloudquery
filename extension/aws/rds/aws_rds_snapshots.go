...
func ListSnapshotsColumns() []table.ColumnDefinition {
	return []table.ColumnDefinition{
		...
		// table.TextColumn("cluster_create_time_ext"),
		// table.TextColumn("cluster_create_time_loc"),
		// table.TextColumn("cluster_create_time_loc_cache_end"),
		// table.TextColumn("cluster_create_time_loc_cache_start"),
		...
		// table.TextColumn("cluster_create_time_loc_cache_zone_offset"),
		...
		// table.TextColumn("cluster_create_time_loc_zone_offset"),
		table.TextColumn("cluster_create_time_wall"),
		...
		// table.TextColumn("snapshot_create_time_ext"),
		// table.TextColumn("snapshot_create_time_loc"),
		// table.TextColumn("snapshot_create_time_loc_cache_end"),
		// table.TextColumn("snapshot_create_time_loc_cache_start"),
		...
		// table.TextColumn("snapshot_create_time_loc_cache_zone_offset"),
		...
		// table.TextColumn("snapshot_create_time_loc_zone_offset"),
		// table.TextColumn("snapshot_create_time_wall"),
